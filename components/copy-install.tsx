...
export function CopyInstall(
  ...
  return (
    <button
      ...
      {...props}
      className={cn(
        "bg-secondary dark:bg-secondary dark:hover:bg-muted flex items-center gap-x-3 rounded-full border px-6 py-2 text-start outline-none transition-colors hover:bg-white md:py-3",
        props.className
      )}
    >

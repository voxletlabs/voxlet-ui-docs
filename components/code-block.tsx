...
export async function CodeBlock({
  ...
  return (
    <Base.CodeBlock
      allowCopy={false}
      {...wrapper}
      className={cn("bg-secondary/50 m-0 mt-2", wrapper?.className)}
    >
      {rendered}
    </Base.CodeBlock>
  );
    ...
    >
      ...
      <CodeBlock
        ...
        wrapper={{
          allowCopy: false,
          className:
            "bg-secondary/50 dark:bg-secondary/60 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 m-auto w-11/12 backdrop-blur-xl border-none",
          ...props.wrapper,
        }}
      />
    </div>
